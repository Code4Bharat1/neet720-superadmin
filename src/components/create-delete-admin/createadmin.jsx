...
export default function AddAdminPage() {
  ...
  const handleGeneratePassword = () => {
    const newPassword = generateRandomPassword();
    setFormData((prev) => ({ ...prev, PassKey: newPassword }));
  ...
  const handleRegenerateAdminId = () => {
    ...
    toast.success("New Admin ID generated!");
  };
  ...
  const sendEmailToAdmin = async (
    ...
    try {
      ...
      if (res.status === 200) console.log("Email sent successfully!");
    } catch (err) {
      toast.error("Admin created but email sending failed.");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      form.append("address", formData.address);
      form.append("HodName", formData.HodName);
      form.append("instituteName", formData.instituteName); // <-- NEW FIELD
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold">Add Admin</h1>
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/remove-admin"
                className="px-4 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg"
              >
                <ArrowLeft className="w-4 h-4 inline" /> Remove Admin
              </Link>
              <Image
                src="/neet720_logo.jpg"
                alt="Neet720 Logo"
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 px-8 py-8">
            <h2 className="text-3xl font-bold text-white flex items-center">
              <UserPlus className="w-8 h-8 mr-3" />
              Create New Admin
            ...
            <p className="text-blue-100 mt-2 text-lg">
              Fill the details to create admin
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div className="pb-4 border-b">
                  <h3 className="text-xl font-bold flex items-center">
                    <User className="w-5 h-5 text-blue-600 mr-2" /> Basic
                    Information
                  </h3>
                </div>
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 relative">
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-4 border-2 rounded-xl bg-gray-50"
                    ...
                    <button
                      type="button"
                      onClick={handleGeneratePassword}
                      className="px-4 py-4 bg-green-600 text-white rounded-xl"
                    >
                      <RefreshCw className="w-5 h-5" />
                    </button>
                    ...
                    {formData.PassKey && (
                      <button
                        type="button"
                        onClick={handleCopyPassword}
                        className="px-4 py-4 bg-gray-600 text-white rounded-xl"
                      >
                        <Copy className="w-5 h-5" />
                      </button>
                    )}
                ...
                {/* COURSE */}
                <div>
                  <label className="block font-semibold mb-3">Course</label>
                  <input
                    type="text"
                    name="Course"
                    value={formData.Course}
                ...
                {/* ROLE */}
                <div>
                  <label className="block font-semibold mb-3">Role</label>
                  <select
                    name="role"
                    value={formData.role}
                    onChange={handleChange}
              ...
              <div className="space-y-8">
                ...
                {/* MOBILE */}
                <div>
                  <label className="block font-semibold mb-3">Mobile</label>
                  <input
                    type="tel"
                    name="mobileNumber"
                    value={formData.mobileNumber}
                ...
                {/* ADDRESS */}
                <div>
                  <label className="block font-semibold mb-3">Address</label>
                  <textarea
                    name="address"
                    value={formData.address}
                    required
                ...
                {/* HOD NAME */}
                <div>
                  <label className="block font-semibold mb-3">HOD Name</label>
                  <input
                    type="text"
                    name="HodName"
                    value={formData.HodName}
            ...
            <div className="mt-12">
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-bold py-5 rounded-2xl text-lg"
              >
